...
module.exports = function loadGrammar(entryPath, loader, options) {
  ...
  return loadModuleGraph(entry, loader, options).then(function(modules) {
    return processModules(modules, entry, options || {});
  });
};

function processModules(_modules, entry, options) {
  var modules = (options.preprocess && options.preprocess(_modules)) || _modules;
